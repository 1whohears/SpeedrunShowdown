...
public class SpeedrunShowdown extends JavaPlugin implements Runnable {
    ...
    private void deleteWorldFolders() {
        ...
        deletePartialWorld(homeFolder, getTheNetherWorldName());
        deletePartialWorld(homeFolder, getTheEndWorldName());
    }
    ...
    private static void deletePartialWorld(File homeFolder, String worldName) {
        ...
        deleteDir(worldFolder, "DIM-1");
        deleteDir(worldFolder, "DIM1");
